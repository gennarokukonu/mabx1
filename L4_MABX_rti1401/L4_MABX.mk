...
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2018a
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2018a\bin
RELEASE_VERSION                = R2018a
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = L4_MABX
MODULES                        = rt_matrx.c rt_printf.c L4_MABX_data.c L4_MABX_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_sfcn_helper.c dsa_gen_tx_RTMapsEncode.c dsa_gen_rx_RTMapsDecode.c
S_FUNCTIONS                    = dsa_tcpip_bkg_sfcn.c dsa_tcpip_irq_l1_sfcn.c dsa_tcpip_irq_l2_sfcn.c dsa_tcpip_setup_sfcn.c dsa_tcpip_udp_sfcn.c
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 9
TID01EQ                        = 0
...
RTWCUST_INCLUDES = \
	"$(START_DIR)" \
	"$(START_DIR)\L4_MABX_rti1401" \
	"$(START_DIR)\src" \
	"$(START_DIR)\src\dsa_gen_code"
...
TMP_PATH_CC += "C:\PROGRA~1\DSPACE~3\MATLAB\RTICAN\TLC"
TMP_PATH_CC += "C:\PROGRA~1\DSPACE~4\DSPACE~2.1\MATLAB\TCPIP_~1\Sfcn"
TMP_PATH_CC += "$(START_DIR)\src\dsa_gen_code"
TMP_PATH_CC += "$(MATLAB_ROOT)\rtw\c\src"
