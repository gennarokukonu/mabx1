...
extern void L4_MABX_If_Then_Else_j(boolean_T rtu_If, real_T rtu_Then, real_T
  rtu_Else);
...
extern void L4_MABX_If_Then_Else_o(boolean_T rtu_If, real_T rtu_Then,
  ENUM_XBR_EBI_MODE_T rtu_Then_b, ENUM_XBR_PRIORITY_T rtu_Then_bo,
  ENUM_XBR_CONTROL_MODE_T rtu_Then_a, ENUM_XBR_PASS_THROUGH_ACTIVE_T rtu_Then_g,
  real_T rtu_Then_d, real_T rtu_Then_h, real_T rtu_Else, ENUM_XBR_EBI_MODE_T
  rtu_Else_e, ENUM_XBR_PRIORITY_T rtu_Else_d, ENUM_XBR_CONTROL_MODE_T rtu_Else_o,
  ENUM_XBR_PASS_THROUGH_ACTIVE_T rtu_Else_h, real_T rtu_Else_f, real_T
  rtu_Else_k, B_If_Then_Else_L4_MABX_f_T *localB);
