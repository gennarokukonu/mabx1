function ST = xmlwrite_custom(fileName, docNode)
% ST = xmlwrite_custom(FILENAME, docNode) Saves (properly!) an XML file.
...
%			% Do XML stuff here... %
%			xmlwrite_custom('somefile.xml', docNode);
%
%
%		Created by Gilad Yahalom
%		Feel free to modify code, please leave acknowledgments to original author
%
