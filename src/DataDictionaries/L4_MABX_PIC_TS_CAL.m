...
LAT_STEER_SRC_SELECTOR_APV = ptc_matlab_lib.PTC_MBDS_Parameter('Value', ENUM_LAT_STEER_SOURCE_T.PIC_STANLEY, ...
...
% STANLEY_GAIN_APV
STANLEY_GAIN_APV = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.55, ...
    'Description', 'Stanley Controller Gain K', ...
    'Min', 0, ...
	'Max', 1);

% STANLEY_GAIN_KSOFT_APV
STANLEY_GAIN_KSOFT_APV = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0, ...
    'Description', 'Stanley Controller Gain Ksoft', ...
    'Min', 0, ...
	'Max', 10);

% STANLEY_GAIN_KDYAW_APV
STANLEY_GAIN_KDYAW_APV = ptc_matlab_lib.PTC_MBDS_Parameter('Value', -0.35, ...
    'Description', 'Stanley Controller Gain Kd,yaw', ...
    'Min', -1, ...
	'Max', 1);

% STANLEY_GAIN_KDSTEER_APV
STANLEY_GAIN_KDSTEER_APV = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.18, ...
    'Description', 'Stanley Controller Gain Kd,steer', ...
    'Min', -1, ...
	'Max', 1);
...
% Lateral_Control_P
Lateral_Control_P = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.6, ...
...
% Lateral_Control_D
Lateral_Control_D = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.07, ...
    'Description', 'Lateral Controller Devivative Value', ...
	'Min', 0, ...
	'Max', 10);

% Yaw_Rate_FF_Gain
Yaw_Rate_FF_Gain  = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.2, ...
...
% LATERAL_GAIN_SCHEDULE_APV
LATERAL_GAIN_SCHEDULE_APV = ptc_matlab_lib.PTC_MBDS_Parameter('Value', ENUM_SWITCH_T.ON, ...
    'Description', 'Enable Understeer Correction Schedule');

% UndersteerCorection
UndersteerCorection = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.18, ...
    'Description', 'The Haris Fudge Factor', ...
    'Min', 0, ...
    'Max', 2.5);

% Lateral_Control_Error_Limit
Lateral_Control_Error_Limit = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.2, ...
    'Description', 'Lateral Control Error Saturation Limit (rad)', ...
    'Min', 0, ...
    'Max', 1);

% Lateral_Control_Error_Rate_Limit
Lateral_Control_Error_Rate_Limit = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.04, ...
...
Lateral_Control_Rate_Limit_APV = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.04, ...
