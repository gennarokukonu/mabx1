...
%% Lateral_Control_P
Lateral_Control_P = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.2, ...
...
%% Lateral_Control_D
Lateral_Control_D = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.2, ...
    'Description', 'Lateral Controller Devivative Value', ...
	'Min', 0, ...
	'Max', 100);

%% Yaw_Rate_FF_Gain
Yaw_Rate_FF_Gain  = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.25, ...
...
%% UndersteerCorection
UndersteerCorection = ptc_matlab_lib.PTC_MBDS_Parameter('Value', 0.75, ...
