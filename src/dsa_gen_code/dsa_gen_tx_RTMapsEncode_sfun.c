 ...
 *
 *         void Update_Tx_RTMapsEncode(RTMapsTX u1[1], uint8 y1[24], uint32 y2[1])
 *
 *    Simulink version           : 9.1 (R2018a) 06-Feb-2018
 *    C source code generated on : 27-Feb-2020 12:27:56
 *
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        /* Get information for accessing RTMapsTX.EngageReq */
        __dtBusInfo[6] = ssGetBusElementOffset(S, __RTMapsTXId, 3);
        __dtBusInfo[7] = __dtSizeInfo[1];

        /* Get information for accessing RTMapsTX.LogEventPB */
        ...
        __dtBusInfo[12] = ssGetBusElementOffset(S, __RTMapsTXId, 6);
        __dtBusInfo[13] = __dtSizeInfo[2];

        /* Get information for accessing RTMapsTX.BrakeSW */
        __dtBusInfo[14] = ssGetBusElementOffset(S, __RTMapsTXId, 7);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        (void) memcpy(&__u1BUS[0].EngageReq, u1 +  __dtBusInfo[6],  __dtBusInfo[7]);
        (void) memcpy(&__u1BUS[0].LogEventPB, u1 +  __dtBusInfo[8],  __dtBusInfo[9]);
        (void) memcpy(&__u1BUS[0].AutonomousEnabled, u1 +  __dtBusInfo[10],  __dtBusInfo[11]);
        (void) memcpy(&__u1BUS[0].MABX_Mode, u1 +  __dtBusInfo[12],  __dtBusInfo[13]);
        (void) memcpy(&__u1BUS[0].BrakeSW, u1 +  __dtBusInfo[14],  __dtBusInfo[15]);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {226351300, 3237273652, 2932730169, 2282777742};
        int_T status;
