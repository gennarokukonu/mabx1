 ...
 *
 *         void Update_Tx_RTMapsEncode(RTMapsTX u1[1], uint8 y1[23], uint32 y2[1])
 *
 *    Simulink version           : 9.1 (R2018a) 06-Feb-2018
 *    C source code generated on : 22-Jan-2020 16:46:02
 *
...
/**
     ...
     def.OutputFcnSpec = 'void Update_Tx_RTMapsEncode(RTMapsTX u1[1], uint8 y1[23], uint32 y2[1])';
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {447840484, 1809781790, 597539275, 3404960708};
        int_T status;
